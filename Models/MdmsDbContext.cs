...
public partial class MdmsDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            // Use connection string from appsettings.json via dependency injection
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ConsumerId).HasName("PK__Consumer__63BBE99A874A2B45");
        ...
        {
            entity.HasKey(e => e.MeterId).HasName("PK__Meters__59223B8C0448709E");
        ...
        {
            entity.HasKey(e => e.BillId).HasName("PK__MonthlyB__11F2FC4A0301E136");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__Users__A9D105349FC0BA7D").IsUnique();
